...
-- Grant table access so the hook can read parents and child_profiles
GRANT SELECT ON TABLE public.parents TO supabase_auth_admin;

GRANT SELECT ON TABLE public.child_profiles TO supabase_auth_admin;
