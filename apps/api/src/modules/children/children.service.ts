...
export class ChildrenService {
    ...
    async createChildProfile(
        ...
        try {
            ...
            this.logger.error(
                `Failed to create child profile for parent ${parentId}: ${error instanceof Error ? error.message : 'Unknown error'
                }`,
                undefined,
                'ChildrenService',
            );
    ...
    async getChildProfiles(parentId: string): Promise<ChildProfileDto[]> {
        try {
            ...
            this.logger.error(
                `Failed to get child profiles for parent ${parentId}: ${error instanceof Error ? error.message : 'Unknown error'
                }`,
                undefined,
                'ChildrenService',
            );
