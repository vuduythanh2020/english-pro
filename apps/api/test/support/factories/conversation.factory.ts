...
export function conversationScenarioFactory(
  ...
  return {
    ...
    description: input?.description ?? 'A test conversation scenario for kids',
...
export function conversationSessionFactory(
  ...
  return {
    id,
    childId: input?.childId ?? '00000000-0000-4000-b000-000000000001',
    scenarioId: input?.scenarioId ?? '00000000-0000-4000-c000-000000000001',
